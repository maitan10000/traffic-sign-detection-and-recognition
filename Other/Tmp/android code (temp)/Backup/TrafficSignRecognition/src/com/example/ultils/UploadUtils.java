...
//              }); 
         ...
         else
         {
              try { 
                  ...
                  Log.i("uploadFile", "HTTP Response ne2 : "
                          + serverResponseMessage );
                  //Toast.makeText(getApplicationContext(), "File Upload Complete: "+ serverResponseMessage,Toast.LENGTH_LONG).show();
                  ...
                  if(serverResponseCode == 200){
                      ...
                      Log.i("uploadFile", "HTTP Response ne3 : "
                              + reponseJson );
//                      runOnUiThread(new Runnable() {
//                           public void run() {
//                                
